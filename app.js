...
function addCourseToSchedule(curso, seccion) {
    horarioSeleccionado.push({ sigla: curso.sigla, nombre: curso.nombre, seccionId: seccion.id, horario: seccion.horario });
    renderSchedule(); 
    renderSelectedList();
}
...
function renderSelectedList() {
    ...
    table.innerHTML = `<thead><tr><th>Código</th><th>Sec.</th><th>Nombre del Curso</th><th></th></tr></thead><tbody></tbody>`;
